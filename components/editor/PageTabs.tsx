...
export default function PageTabs({
  ...
  return (
    <div className="flex-shrink-0 flex items-stretch gap-1 bg-dark-surface border-b border-dark-border px-2 py-1 overflow-x-auto">
      {pages.map((pg) => {
      ...
      <div className="relative flex-shrink-0">
        ...
        {addMenuOpen && (
          <>
            ...
            <div className="absolute left-0 top-full mt-1 z-20 w-40 bg-dark-surface border border-dark-border rounded-lg shadow-xl overflow-hidden">
              <button
                type="button"
